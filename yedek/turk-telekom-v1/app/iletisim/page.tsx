...
import { Mail, MapPin, Award, Clock, ArrowRight } from 'lucide-react';
  ...
  return (
    <article className="max-w-4xl mx-auto px-[5%] py-12 sm:py-16">
      ...
      <div className="max-w-lg mx-auto mb-10">
        ...
        <Link
          href="/#wizard"
          className="group block bg-brand-50 hover:bg-brand-100 active:bg-brand-200 border-2 border-brand-500/30 rounded-2xl p-6 transition min-h-[140px]"
        >
