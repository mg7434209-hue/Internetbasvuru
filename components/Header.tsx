  ...
  return (
    <header className="bg-brand-500 px-[5%] py-3.5 flex justify-between items-center sticky top-0 z-[1000] border-b border-white/10 shadow-md">
      ...
      >
        ...
        />
        {/* Satış noktası bilgisi — geniş ekranda göster, dar ekranda gizle */}
        <span className="hidden lg:flex flex-col leading-tight border-l border-white/20 pl-4">
      ...
      {/* SAĞ: Nav (desktop) + her ekranda görünen Başvur butonu */}
      <div className="flex items-center gap-4">
        <nav className="hidden md:flex items-center gap-5 lg:gap-7 text-sm font-semibold text-white/85">
        ...
        <Link
          href="/#paketler"
          className="bg-accent-500 hover:bg-accent-400 text-tc-navy text-sm px-4 py-2.5 md:px-5 rounded-full font-bold transition min-h-[40px] inline-flex items-center whitespace-nowrap"
        >
          Hemen Başvur
        </Link>
      </div>
